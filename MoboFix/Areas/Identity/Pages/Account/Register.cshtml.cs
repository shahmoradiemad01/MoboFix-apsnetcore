...
namespace MoboFix.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Compare("Password", ErrorMessage = "با رمزعبور همخوانی ندارد!")]
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    _context.Shops.Add(new Shop()
                    {
                        UserId = userId,
                        Name = Input.ShopName,
                        PhoneNumber = Input.ShopPhoneNumber,
